...
- **Image Stacking:** Combining multiple aligned images in order to reduce noise and 
  enhance details.
...
**Please note that the tksiril module is now deprecated owing to lack of Wayland support. New scripts with GUIs should use PyQt6, and existing scripts should be converted to use PyQt6 when updated. The tksiril submodule will be removed from master once there are no more scripts in the repository using it.**
